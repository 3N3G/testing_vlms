This contains the mechanics of the game as well as hints. The vla probably shouldn't have access to the floor hints but should have access to some basic mechanics of the game as well as goals.
